...
js+='\n;["PROGRAMME_SEANCES","CIBLES_PAR_DEFAUT","photoEstDeToi","verifierLiens","_wm","LIENS_IMAGES","_liensCasses","renderAccueil","prochainMoment","resteDuJour","suggestionsAccueil","momentsPris","photoRecette","_vignetteDefaut","PHOTOS","MOMENTS","moment","couleurMoment","_refreshToday","_burnSave","estimateTDEE","renderTDEEBlock","toggleBackupList","annulerRestauration","clearApiKey","openItemDetail","saveItemDetail","stepInvPkg","renderInvDiag","invIssues","itemMealMacros","findItem","apprendNomsIngredients","resolveInv","runMergeDuplicates","_triRecettes","_densProt","setRecTri","toggleRecTriDir","renderRecTri","canCook","cookedToday","titreDepuisInventaire","_nomCourt","_catDeLArticle","invPickQty","applyInvPick","openInvPick","invAddMeal","shiftDate","_majBandeauJour","coachActivite","getBurn","coachAdvice","_enPriseDeMasse","openAddMeal","toggleIngMacros","toggleEmMacros","_emMkRow","_emApplyStockDelta","renderInvSuggestions","manualAddMeal","confirmAddMealFinal","recalcAddMealMacros","_toleranceDlc","dlcAnomalie","effDlc","invIssues"].forEach(function(n){try{globalThis[n]=eval(n);}catch(e){}});';
