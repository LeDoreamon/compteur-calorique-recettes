...
js+='\n;["openAddMeal","toggleIngMacros","toggleEmMacros","_emMkRow","_emApplyStockDelta","renderInvSuggestions","manualAddMeal","confirmAddMealFinal","recalcAddMealMacros","_toleranceDlc","dlcAnomalie","effDlc","invIssues","manualAddMeal","setInvMode","openInvPick","invPickQty","applyInvPick","renderInvSuggestions","recalcAddMealMacros","_toleranceDlc","dlcAnomalie","effDlc","invIssues","itemMealMacros","findItem","apprendNomsIngredients","resolveInv","runMergeDuplicates","_triRecettes","_densProt","setRecTri","toggleRecTriDir","renderRecTri","canCook","cookedToday","titreDepuisInventaire","_nomCourt","_catDeLArticle","invPickQty","applyInvPick","openInvPick","invAddMeal","openAddMeal","toggleIngMacros","toggleEmMacros","_emMkRow","_emApplyStockDelta","renderInvSuggestions","manualAddMeal","confirmAddMealFinal","recalcAddMealMacros","_toleranceDlc","dlcAnomalie","effDlc","invIssues","renderInvPick","_invPickSum","confirmAddMealFinal","openFreeOverlay","fillFreeReview","confirmFreeEntry","renderFreeInv","toggleFreeInv","updateFreeTotals"].forEach(function(n){try{globalThis[n]=eval(n);}catch(e){}});';
