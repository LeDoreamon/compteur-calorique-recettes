...
js+='\n;["_refreshToday","_burnSave","estimateTDEE","renderTDEEBlock","toggleBackupList","annulerRestauration","clearApiKey","openItemDetail","saveItemDetail","stepInvPkg","renderInvDiag","invIssues","itemMealMacros","findItem","apprendNomsIngredients","resolveInv","runMergeDuplicates"].forEach(function(n){try{globalThis[n]=eval(n);}catch(e){}});';
...
js+='\n;["openAddMeal","manualAddMeal","setInvMode","openInvPick","invPickQty","applyInvPick","renderInvSuggestions","recalcAddMealMacros","itemMealMacros","findItem","apprendNomsIngredients","resolveInv","runMergeDuplicates","renderInvPick","_invPickSum","confirmAddMealFinal","openFreeOverlay","fillFreeReview","confirmFreeEntry","renderFreeInv","toggleFreeInv","updateFreeTotals"].forEach(function(n){try{globalThis[n]=eval(n);}catch(e){}});';
